...
<div class="splash-container">
    <div class="splash">
        <h1 class="splash-head"><div id="s_fm" class="s_form">
		<form name="f1" onsubmit="return getUrl(this)">
			<div id=""myform"" class="myform">
				<input id="kw" type=text name=word size="30" maxlength="100">
			</div>
			<div>
...
<%-- 		<tr><td><c:out value="${item.id}____${item.accountNum}____${item.nickname}____${item.email}____${item.password}"/></td></tr> --%>
<%-- 		</c:forEach> --%>
<!-- 		</table> -->
<!-- 		</div> -->
	</div>
...
<div class="content-wrapper">
    ...
    <div class="ribbon l-box-lrg pure-g">
        <div class="l-box-lrg is-center pure-u-1 pure-u-md-1-2 pure-u-lg-2-5">
            <img class="pure-img-responsive" alt="File Icons" width="300" src="<%=path%>/images/common/file-icons.png">
        </div>
