...
public class httpUnitTestSample {  
    ...
    public static void testGetHtmlContent() throws MalformedURLException,  
        ...
        // 向指定的URL发出请求，获取响应  
        WebResponse wr = wc.getResponse("http://www.sosobtc.com/");  
        // 用getText方法获取相应的全部内容  
    ...
    public static void testClickLink() throws MalformedURLException,  
        ...
        WebConversation wc = new WebConversation();  
        // 获取响应对象  
        WebResponse resp = wc.getResponse("http://www.sosobtc.com/");  
        // 获得页面链接对象  
    ...
    public static void testTableContent() throws MalformedURLException,  
        ...
        // 获取响应对象  
        WebResponse resp = wc  
                .getResponse("http://www.btc38.com/httpAPI.php?n=0.33343298936041815");  
  
        System.out.println(resp.getText());  
        // 获得对应的表格对象  
        WebTable webTable = resp.getTables()[0]; 
        @SuppressWarnings("unused")
		WebTable[] web=resp.getTables();
        WebTable table=null;
        for(WebTable t:resp.getTables()){
        	System.out.println(t.getClassName());
        	if(t.getClassName().equalsIgnoreCase("markets"))
        	table=t;
        }
